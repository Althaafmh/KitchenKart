...
/**
 * Adapter for displaying products in the seller's product management screen.
 * @noinspection ALL
 */
public class SellerProductAdapter extends RecyclerView.Adapter<SellerProductAdapter.ProductViewHolder> {
    ...
    public SellerProductAdapter(List<Product> products, OnItemClickListener listener) {
