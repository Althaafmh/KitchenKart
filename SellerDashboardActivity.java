// File: SellerDashboardActivity.java
...
public class SellerDashboardActivity extends AppCompatActivity {
    ...
    private SellerHomeFragment sellerHomeFragment;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // The fab is defined in the activity layout and should be initialized here.
        fabAddProduct = findViewById(R.id.fab_add_product);
        if (fabAddProduct != null) { // Add a null check to be safe
    ...
    private boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.nav_home || id == R.id.nav_manage_products) { // Combine these two as they load the same fragment
